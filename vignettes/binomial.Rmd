...
f <- getBenchmarks(d$x, d$y, family="binomial")
...
## n < p
```{r, fig.width=10, fig.height=10}
d <- randomProblem(50, 200, response="binomial", density = 1, rho=0)
...
## n < p
```{r, fig.width=10, fig.height=10}
d <- randomProblem(50, 200, response="binomial", density = 1, rho=0.95)
